import sys
sys.path.append("/home/skkuedu/TestSite/mKoBertSum/src/")
import make_data
import gc
import glob
import hashlib
...
from transformers import XLNetTokenizer, BertTokenizerFast, BertTokenizer
...
def json_to_bert(jobs, bertData):
    bert = bertData
    datasets = []
    for d in jobs:
        source, tgt = d['src'], d['tgt']
...
def dataPrepro(bertData):
    with open('/home/skkuedu/TestSite/mKoBertSum/ext/data/raw/extractive_test_v2.jsonl', 'r') as json_file:
