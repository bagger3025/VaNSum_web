...
model = PegasusForConditionalGeneration.from_pretrained('/home/skkuedu/VANSum/backend/PEGASUS/base/model-12000')
tokenizer = PegasusTokenizer.from_pretrained('/home/skkuedu/VANSum/backend/PEGASUS/base/model-12000')
