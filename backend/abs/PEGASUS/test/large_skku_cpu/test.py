...
model = PegasusForConditionalGeneration.from_pretrained('/home/skkuedu/VANSum/backend/PEGASUS/large/model-47000')
tokenizer = PegasusTokenizer.from_pretrained('/home/skkuedu/VANSum/backend/PEGASUS/large/model-47000')
