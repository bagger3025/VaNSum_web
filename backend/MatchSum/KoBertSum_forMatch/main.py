...
if __name__ == '__main__':
    ...
    # python main.py -task test -test_from 1209_1236/model_step_7000.pt -visible_gpus 0
        ...
        os.system(f"python make_submission.py -candidate_path result_{model_folder}_{model_name}.candidate -matchsum_datapath ../../data/DATA.jsonl -matchsum_resultpath ../../result/DATA.jsonl")
        #os.system(f"python make_submission.py -candidate_path result_{model_folder}_{model_name}.candidate")
