...
function SummaInputField(){
    ...
    const apiURL = ['/api/SummaRuNNer_with_title', '/api/SummaRuNNer']
            ...
            <div>
                {
                    ...
                    (
                        <div>
                            <label><h3>SummaRuNNer(no title)</h3><span>{kbtTim} seconds</span></label>
                            <label> |
                            <input
                                type="radio"
                                checked={isPnt===true}
    ...
    const showKbt=()=>{
        console.log("line 209", kobertSum);
        return (
            <div>
                {
                    kobert===false?
                    (
                        ...
                        <div>
                            <label><h3>SummaRuNNer(title)</h3><span>{kbtTime} seconds</span></label>
                            <label> |
                            <input
                                type="radio"
                                checked={isP===true}
    ...
    return(
        <>
            <div>
                ...
                <h3>Select Model</h3>
                <label> | <input type="checkbox" checked = {kobert} onChange = {()=>setKobert(!kobert)}/> SummaRuNNer </label>
                <br/>
            ...
            <div style = {rightBox}>
            <label><h5><input type="checkbox" checked={kbtHigh} onChange={()=>{setKbtHigh(!kbtHigh)}}></input>SummaRuNNer(title) Highlight</h5></label>
            <label><h5><input type = "checkbox" checked = {kbtHighnt} onChange={()=>{setKbtHighnt(!kbtHighnt)}}></input>SummaRuNNer(no title) Highlight</h5></label>
                {showKbt()}
                {showKbtnt()}
            </div>
        </>
...
export default SummaInputField;